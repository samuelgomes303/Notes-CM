...
class ListAdapter: RecyclerView.Adapter<ListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.addNote).text = currentItem.descricao
        holder.itemView.findViewById<TextView>(R.id.dateEditText).text = currentItem.data
